CREATE   PROCEDURE _Kardex_SaldoInicialDetallado
...
-- Crear tabla temporal con movimientos anteriores
SELECT
    d.Documento,
    d.TipoDoc,
    d.Fecha,
...
IF EXISTS(SELECT 1 FROM #saldo_inicial_temp)
BEGIN

    DECLARE @ultimaFecha DATE
    DECLARE @ultimaHora DATETIME
    DECLARE @ultimoDocumento CHAR(9)
